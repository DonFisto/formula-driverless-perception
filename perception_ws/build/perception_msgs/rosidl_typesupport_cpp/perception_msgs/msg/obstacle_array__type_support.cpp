...
static const _ObstacleArray_type_support_symbol_names_t _ObstacleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_msgs, msg, ObstacleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perception_msgs, msg, ObstacleArray)),
  }
};
...
{
  return &::perception_msgs::msg::rosidl_typesupport_cpp::ObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perception_msgs, msg, ObstacleArray)() {
  return get_message_type_support_handle<perception_msgs::msg::ObstacleArray>();
}
